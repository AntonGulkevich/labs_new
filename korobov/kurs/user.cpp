...
// public
QString User::popHost() const { return popHost_; }
// public
QString User::smtpHost() const { return smtpHost_; }
// public
quint16 User::popPort() const { return popPort_; }
// public
quint16 User::smtpPort() const { return smtpPort_; }
// public
bool User::auth() const { return auth_; }
// public
void User::auth(bool auth) { auth_ = auth; }
// public
QString User::id() const { return id_; }
//public
